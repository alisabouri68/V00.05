 ...
 **   packArray which is an empty array
 **   packSerial which is set to 0
 *
 *   This code can be used as a starting point for building an object that will store metadata about Axis.
 *
 */
export default {
  Meta: {

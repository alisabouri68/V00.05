...
export const themeColors: Record<ThemeName, ThemeColors> = {
  ...
  placeholder: colors.gray[400],
  visited: colors.violet[500], // اگر واقعاً منظور لینک بازدیدشده است
},
    ...
    success: {
      ...
      active: {
        background: colors.emerald[300],
        text: colors.gray[800],
        border: colors.emerald[200],
      },
      focus: {
        ring: colors.emerald[200],
      },
      selected: {
